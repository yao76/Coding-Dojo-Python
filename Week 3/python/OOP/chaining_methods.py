...
eric.make_deposit(100).make_deposit(100).make_deposit(100).make_widtharwal(50).display_user_balance()

elisa.make_deposit(100).make_deposit(100).make_widtharwal(50).display_user_balance()

bob.make_deposit(500).make_widtharwal(50).make_widtharwal(50).make_widtharwal(50).display_user_balance()
